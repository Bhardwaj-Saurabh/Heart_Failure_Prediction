# Heart Failure Prediction Application using Machine Learning
A simple machine learning based application which predicts heart failure based on person's attributes and medical history.
...
## Overview 
In this project, the objective is to predict whether the person has a risk to heart failure or not based on the following features
- Age
- Anaemia
...
## Team  
[Saurabh Bhardwaj](https://github.com/Bhardwaj-Saurabh)
